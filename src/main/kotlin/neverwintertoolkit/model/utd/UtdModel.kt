package neverwintertoolkit.model.utd


// Generated 2024-01-31T18:13:33.957381
...
class Utd : GffObj {
    companion object {
        val factory: GffFactory<Utd> = GenericGffFactory(Utd::class.java, ".utd")
    }
    override fun writeGff(output: OutputStream) {
        GenericGffWriter(this, ".utd").writeGff(output)
    }
    ...
    @get:NwnField(name = "OnFailToOpen", type = "ResRef")
    ...
    var varTable: List<UtdVarTable>? = null
}
